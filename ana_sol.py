...
data = pd.read_csv("/Users/macuser/Desktop/buildspace/SOLUSD.csv")
...
ax.set_xlabel('Date')
ax.set_ylabel('Price')
fig.suptitle('Stock Prices for a year (SOL)')
...
plt.title('Prediction vs Actual (SOL)')
plt.xlabel('Date')
...
print("\n", svm.predict((np.array([20, 25, 17]).reshape(1,-1))), "\n")
